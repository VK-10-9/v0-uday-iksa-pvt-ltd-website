...
import { ArrowRight, Sun, Zap, Lightbulb, Building, ShieldCheck, Sparkles, Layers, Minimize } from "lucide-react"
...
export default function SkytubePage() {
    const features = [
        {
            title: "Optical Channelling",
            description: "Advanced internal reflective coating with 99.7% reflectivity to deliver light even through long, bent tubes.",
            icon: Lightbulb,
        },
        {
            title: "Compact Integration",
            description:
                "Designed to penetrate through tight ceiling voids and complex service layers where traditional skylights cannot fit.",
            icon: Minimize,
        },
        {
            title: "Zero Heat Gain",
            description: "Isolated light transport ensures that only visible spectrum light enters, reflecting infra-red heat back out.",
            icon: Sun,
        },
        {
            title: "Diffused Comfort",
            description: "Prismatic bottom lenses ensure soft, glare-free light distribution that mimics high-quality artificial LEDs.",
            icon: Layers,
        },
    ]
    ...
    const applications = [
        {
            name: "Interior Office Cores",
            image: "/images/nanosun-app-1.jpg",
            description: "Delivering healthy daylight to internal cabins and corridors far from perimeter windows.",
        },
        {
            name: "Complex PEB Structures",
            image: "/images/nanosun-app-2.jpg",
            description: "Flexible routing through industrial roof trusses and insulation layers for localized light focus.",
        },
        {
            name: "Retrofit Zones",
            image: "/images/nanosun-app-3.jpg",
            description: "Seamless integration into existing facilities with minimal structural modification required.",
        },
    ]
                    ...
                    <div className="grid lg:grid-cols-2 gap-24 items-center">
                        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1 }}>
                            <div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 rounded-full px-8 py-2.5 mb-10 backdrop-blur-md">
                                <Lightbulb className="h-4 w-4 text-brand-orange-500" />
                                <h2 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em]">Precision Optics</h2>
                            </div>
                            <h1 className="text-6xl md:text-9xl font-black text-white mb-10 tracking-tighter uppercase leading-none">
                                SKYTUBE <br /> <span className="brand-gradient-text">LIGHTLINE</span>
                            </h1>
                            <p className="text-xl text-gray-400 mb-16 leading-relaxed max-w-2xl font-medium">
                                Tubular daylighting engineered for architectural flexibility. Channelling pure solar energy through high-performance optical conduits into any interior space.
                            </p>
                            <div className="flex flex-wrap gap-6">
                                <Link href="/contact" className="block w-full sm:w-auto">
                                    <Button size="lg" className="w-full sm:w-auto bg-white text-black hover:bg-brand-orange-500 hover:text-white rounded-2xl px-16 py-8 text-sm font-black uppercase tracking-[0.2em] shadow-2xl shadow-white/5 active:scale-95 group">
                                        Engineer Layout <ArrowRight className="ml-3 h-5 w-5 group-hover:translate-x-2 transition-transform" />
                                    </Button>
                                </Link>
                        ...
                        >
                            <Image
                                src="/images/skytube-hero.jpg"
                                alt="SKYTUBE Technology"
                                fill
                            ...
                            <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-slate-950 to-transparent p-12 flex items-end">
                                <div className="bg-slate-900/60 backdrop-blur-2xl border border-white/10 p-10 rounded-[48px] w-full">
                                    <Layers className="h-8 w-8 text-brand-orange-400 mb-6" />
                                    <p className="text-xl font-black text-white uppercase tracking-tighter mb-2">99.7% Reflectivity</p>
                                    <p className="text-gray-400 text-sm font-medium">Industry-leading light transport through specialized internal finishes.</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            <section className="py-40 relative px-6 lg:px-12 bg-slate-950/50">
                <div className="container mx-auto">
                    <div className="max-w-4xl mb-32">
                        <h2 className="text-4xl md:text-7xl font-black text-white mb-10 uppercase tracking-tighter leading-none">Optical Physics</h2>
                        <p className="text-xl text-gray-400 leading-relaxed font-medium">
                            SKYTUBE captures daylight via an omni-directional dome, focuses it through a highly-reflective rigid or flexible tube, and delivers it via architectural diffusers. It defies the constraints of building depth, bringing vitamin D and visual comfort to basement cores and internal halls.
                        </p>
                    </div>
            ...
            <section className="py-40 relative px-6 lg:px-12 bg-slate-950">
                <div className="container mx-auto">
                    <div className="text-center mb-32">
                        <h2 className="text-5xl md:text-8xl font-black mb-10 text-white uppercase tracking-tighter leading-none">Architectural <span className="brand-gradient-text">Reach</span></h2>
                        <p className="text-[10px] font-black text-gray-600 uppercase tracking-[0.5em]">Deep Space Solutions</p>
                    </div>
                ...
                <div className="container mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-white/90 max-w-3xl mx-auto mb-16 leading-relaxed relative z-10 font-black uppercase tracking-[0.4em] text-xs opacity-90">
                            Optical Precision • Zero Heat Gain • Sustainable Wellness
                        </p>
                        <div className="flex flex-wrap justify-center gap-10 relative z-10">
                            <Link href="/contact" className="block w-full sm:w-auto">
                                <Button size="lg" className="w-full sm:w-auto bg-white text-black hover:bg-black hover:text-white transition-all duration-300 rounded-3xl px-20 py-10 text-xl font-black shadow-2xl shadow-white/10 uppercase tracking-[0.3em]">
                                    Start Optical Audit <ArrowRight className="ml-4 h-8 w-8" />
                                </Button>
                            </Link>
                        </div>
                    </motion.div>
