          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-[0.02] group-hover:opacity-[0.05] transition-opacity">
                <p className="text-[220px] font-black uppercase tracking-tighter select-none -rotate-12">CAMPUS</p>
              </div>
              <div className="relative z-20 text-center">
                <GraduationCap className="h-32 w-32 text-brand-orange-500/20 mb-10 mx-auto group-hover:scale-110 transition-transform duration-700" />
            ...
            {projects.map((project, index) => (
              ...
              >
                <div className={`relative h-[600px] rounded-[72px] border border-white/5 bg-white/[0.02] flex items-center justify-center overflow-hidden group shadow-2xl ${index % 2 !== 0 ? 'lg:order-2' : ''}`}>
                  ...
                  <div className="relative z-20 text-center">
                    <GraduationCap className="h-40 w-40 text-brand-orange-500/10 mb-8 mx-auto group-hover:scale-110 group-hover:rotate-12 transition-transform duration-700" />
