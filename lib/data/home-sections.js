...
export const solutionsData = {
    ...
    features: [
        ...
        { title: "Lifetime Leak-Proof", description: "Precision seals for pitched roofs or flat roof products. Zero rain enters your building." },
...
export const aboutData = {
    ...
    description: [
        ...
        "Based in Hubballi, Karnataka, we design and manufacture natural sky lights and roof ventilation systems that are installed in factories, warehouses, schools, hospitals, offices, and homes.",
    ...
    values: [
        {
            icon: Eye,
            title: "Vision",
            description: "A future where every building uses the sun's free energy — instead of paying for artificial light.",
        },
        {
            icon: Target,
            title: "Mission",
...
export const testimonialData = {
    ...
    description: "Real impact stories from leading industrial and commercial organizations who transitioned to sustainable engineering.",
    testimonials: [
        {
            id: 1,
            name: "Krishnappa",
