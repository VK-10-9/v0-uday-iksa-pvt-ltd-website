      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Leading manufacturer of natural daylight and ventilation systems, providing sustainable solutions for over
              15 years.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/innovations" className="text-gray-300 hover:text-white transition-colors">
                  Innovations
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/innovations/nanosun" className="text-gray-300 hover:text-white transition-colors">
                  NANOSUN Daylight Systems
                </Link>
              </li>
              <li>
                <Link href="/innovations/nanovent" className="text-gray-300 hover:text-white transition-colors">
                  NANOVENT Ventilation Systems
                </Link>
              </li>
              <li>
                <Link href="/innovations/skytube" className="text-gray-300 hover:text-white transition-colors">
                  Skytube Tubular Daylight
                </Link>
              </li>
              <li>
                <Link href="/innovations/custom" className="text-gray-300 hover:text-white transition-colors">
                  Custom Solutions
                </Link>
              </li>
              <li>
                <Link href="/innovations/installation" className="text-gray-300 hover:text-white transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">&copy; {currentYear} Uday IKSA Pvt Ltd. All rights reserved.</p>
