    ...
    >
      {heroStats.map((stat, index) => (
        ...
        >
          ...
          />
          <div className="relative brand-glass rounded-2xl p-6 group-hover:border-brand-orange-500/30 transition-all duration-300">
            ...
            <motion.div
              className="text-4xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent group-hover:from-brand-orange-400 group-hover:to-brand-red-400 transition-all duration-300"
