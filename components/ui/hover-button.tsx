  ...
  return (
    <button
      ...
      className={cn(
        ...
        "before:z-[1]",
        "before:shadow-[inset_0_0_0_1px_rgba(212,175,55,0.3),inset_0_0_16px_0_rgba(212,175,55,0.2),inset_0_-3px_12px_0_rgba(212,175,55,0.25),0_1px_3px_0_rgba(0,0,0,0.50),0_4px_12px_0_rgba(0,0,0,0.45)]",
        "before:mix-blend-multiply before:transition-transform before:duration-300",
        "active:before:scale-[0.975]",
        "hover:before:shadow-[inset_0_0_0_1px_rgba(212,175,55,0.4),inset_0_0_16px_0_rgba(212,175,55,0.3),inset_0_-3px_12px_0_rgba(212,175,55,0.35),0_1px_3px_0_rgba(0,0,0,0.50),0_4px_12px_0_rgba(0,0,0,0.45)]",
        className,
      )}
